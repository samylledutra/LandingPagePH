...
function HeroSection({ onButtonClick }) {
  return (
    <section className="firstSection relative pt-10 pb-20 px-[32px] bg-cover bg-center" style={{ backgroundImage: `url(${Banner})` }}>
      ...
      <div className="relative z-10 max-w-[65rem] mx-auto px-4">
        <h1 className="uppercase pt-[55px] pr-[520px] text-[26px] font-bold leading-tight text-customBlue mb-6 ">
        Você percebe que há algo além do que os olhos conseguem enxergar? 
        </h1>
        <p className="mt-4 pr-[525px] text-[18px] text-justify">
        ...
        <p className="mt-4 pr-[520px] text-[18px] text-justify">
